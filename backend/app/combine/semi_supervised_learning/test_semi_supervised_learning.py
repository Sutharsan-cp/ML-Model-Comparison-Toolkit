...
def test_self_training_models():
    ...
    # Prepare semi-supervised data (15% labeled, 85% unlabeled)
    X_labeled, X_unlabeled, y_labeled, y_unlabeled = trainer.prepare_semi_supervised_data(
    ...
    if test_models:
        ...
        for model_name in test_models:
            ...
            try:
                ...
                elif model_name == 'virtual_adversarial':
                    hyperparams = {
                        'learning_rate': 0.01,
                        'xi': 1e-5,
                        'epsilon': 1.0,
                ...
                elif model_name in ['fixmatch', 'mixmatch']:
                    hyperparams = {
                        'learning_rate': 0.003,
                        'epochs': 10
                    }
...
def test_model_comparison():
    ...
    # Create test dataset
    X, y = create_test_dataset(n_samples=200, n_features=5, n_classes=3)
    ...
    test_models = ['label_propagation', 'label_spreading']
    results = []
