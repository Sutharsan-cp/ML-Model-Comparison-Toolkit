...
from streamlit_supervised_demo import get_available_datasets, load_dataset, get_working_models
...
def test_with_real_dataset():
    ...
    # Test with a classification dataset
    print("\n" + "=" * 50)
        ...
        if dataset_name in classification_datasets:
            ...
            if target_col:
                ...
                if X is not None:
                    ...
                    test_models = working_models['classification'][:3]  # Test first 3 models
                    print(f"Testing models: {test_models}")
